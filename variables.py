...
"""Victini is the only pokemon that is registered<br>as #0 in the pokedex.""",
"""Wailord, the blue whale sized pokemon,<br>is lighter than the average human adult.""",
"""Parasect's pokedex entry is the only one<br>that ever mentions a real country. (china)""",
"""Arbok has different patterns on its chest<br>depending on region.""",
"""Alolan dugtrio is worshipped as a deity in Alola.""",
"""Misty's psyduck took 942 episodes to use water gun<br>successfully.""",
"""Abra and Kadabra were originally supposed to be<br>named hocus and pocus.""",
"""Tentacool is 99% water.<br>the other 1 percent is made of poison.""",
"""If you don't have any friends,<br>it is impossible to obtain Golem in red and blue.""",
"""Ponyta is able to jump over the eiffel tower<br>in one leap.""",
